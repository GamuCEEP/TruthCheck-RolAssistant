...
var _dec2 = customElement("g-modal");
let Modal = _class = _dec2(((_class = class Modal extends Shadow {
    html = "";
    cover = (()=>{
  ...
  `;
    ...
    open() {
        this.cover._show(this, true);
    }
    close() {
        this.cover._show(this, false);
    }
    constructor(...args){
        super(...args);
        _initializerDefineProperty(this, "href", _descriptor, this);
        _initializerDefineProperty(this, "clear", _descriptor1, this);
    }
...
}), _descriptor1 = _applyDecoratedDescriptor(_class.prototype, "clear", [
    _dec1
], {
    configurable: true,
    enumerable: true,
